...
const gravitaton = () =>
  +`${
    Math.floor(Math.random() * (Math.floor(1.5) - Math.ceil(0.8))) +
    Math.ceil(0.8)
  }`;
const pipeRandomWidth = () =>
  +`${
    Math.floor(Math.random() * (Math.floor(60) - Math.ceil(20))) + Math.ceil(20)
  }`;
const pipeRandomColod = () =>
  `#${(Math.random().toString(16) + '000000').substring(2, 8).toUpperCase()}`;
const birdRandomJump = () =>
  +`${
    Math.floor(Math.random() * (Math.floor(35) - Math.ceil(10))) + Math.ceil(10)
  }`;
const isEnd = () => {
